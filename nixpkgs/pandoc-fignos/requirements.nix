...
#
# COMMAND:
#   pypi2nix -V 3.6 -e pandoc-fignos
#
...
let
  ...
  generated = self: {
    ...
    "pandoc-fignos" = python.mkDerivation {
      name = "pandoc-fignos-0.21.1";
      src = pkgs.fetchurl {
        url = "https://pypi.python.org/packages/4d/04/092b38a9b7a52ed53ae2b4ce7f9b6886a99ba59d0f80753f2b196924d6c1/pandoc-fignos-0.21.1.tar.gz";
        sha256 = "0kn0hkzwhjc2r3wz7j6qc7mv27pd1xy3cfzhi6mp05j0wb5mvyw4";
      };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
