...
#
# COMMAND:
#   pypi2nix -V 3.6 -e pandoc-tablenos
#
...
let
  ...
  generated = self: {
    ...
    "pandoc-tablenos" = python.mkDerivation {
      name = "pandoc-tablenos-0.17.1";
      src = pkgs.fetchurl {
        url = "https://pypi.python.org/packages/1a/b1/03bbd85defc14332149b83668a47de8814a20bc34f18403333e133ecb4c2/pandoc-tablenos-0.17.1.tar.gz";
        sha256 = "0nn7d011fjkxrk094ipw7s8rz0ighy21afl8ippmjp43ryddgy7v";
      };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
